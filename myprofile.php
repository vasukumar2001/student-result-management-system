...
<body>
	...
	if (isset($_POST['update'])) {
		...
		$sql = "UPDATE registration SET firstname='$firstname', middlename='$middlename',  lastname='$lastname', gender='$gender', birthdate='$birthdate', email='$email',  mobilenumber='$mobilenumber', address='$address', image_path='$image_path' where id=$USER_ID";

		$result = mysqli_query($conn, $sql);
		if ($result) {
			echo header("location:studentpage.php");;
		}
	}
...
";
			...
			<div class="rounded">
				...
				<image class="circle" height="150" width="150" src=<?php echo $row['image_path']; ?>>
			</div><br>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="mno" name="mobilenumber" value=<?php echo $row['mobilenumber']; ?>>
			</div><br>
			<div class="form-group">
			...
			<div class="form-group" style="color: white">
				...
				while ($row = mysqli_fetch_array($result)) {
					...
					echo "<input  type='text'   class='form-control' id='course' name='course' value='$row[course]' no change>";
				}
			...
			<div class="form-group">
				...
				<input type="file" class="form-control" name="image_path" id="image" value=<?php echo $row['image_path']; ?>>
			</div>
